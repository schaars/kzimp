...
// Max size of the small messages that go in the statically allocated buffer
// Must be a multiple of a cache line
#define SMALL_BUFFER_SIZE (CACHE_LINE_SIZE*2)
...
struct kzimp_message
{
   ...
   char smallbuff[SMALL_BUFFER_SIZE]; /* buffer for small messages */
