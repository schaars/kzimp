...
NUM_CONSUMERS_ARRAY=( 1 6 12 18 23 )
#MSG_SIZE_ARRAY=( 1 64 128 512 1024 4096 10240 102400 1048576 )
MSG_SIZE_ARRAY=( 1 4096 1048576 )
NUM_MSG_CHANNEL_ARRAY=( 10 50 100 250 500 )
...
for num_msg_channel in ${NUM_MSG_CHANNEL_ARRAY[@]}; do
   ...
   for num_consumers in ${NUM_CONSUMERS_ARRAY[@]}; do
      ...
      for i in $(seq 0 $(( ${#MSG_SIZE_ARRAY[@]}-1 )) ); do
         ...
         ./launch_bfish_mprotect.sh $num_consumers ${MSG_SIZE_ARRAY[$i]} ${XP_DURATION} $num_msg_channel
